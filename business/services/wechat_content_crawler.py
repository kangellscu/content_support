...
async def crawl_wechat_article(url):
    ...
    async with async_playwright() as p:
        ...
        # 根据id获取文章标题
        title = (await page.text_content('h1#activity-name')).strip()
...
if __name__ == '__main__':
    url = 'https://mp.weixin.qq.com/s/L3xoSbxRDEjKiJHN4j8BFw'  # 替换为实际的公众号文章URL
    result = asyncio.run(crawl_wechat_article(url))
    print(result)